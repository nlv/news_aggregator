...
1. Скопировать файл `config.py.example` в файл `config.py` (если `confog.py` не был ранее создан)

2. Добавить свои значения переменных в файл `config.py`:

> 2.1 Параметры из [my.telegram.org](https://my.telegram.org)
...
> 2.3 id канала, куда будут сливаться все новости
...
Добавить/убавить свои каналы или поменять фильтры для новостей можно в файле `config.py`
...
Парсер модифицирован Leon.V.Nikitin (Leon.V.Nikitin@pravmail.ru, nlv@lab321.ru)
